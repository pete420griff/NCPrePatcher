...
public:
	...
	[[nodiscard]] ModuleParams* getModuleParams() { return reinterpret_cast<ModuleParams*>(&((m_bytes.data())[m_moduleParamsOff])); }
	[[nodiscard]] const ModuleParams* getModuleParams() const { return reinterpret_cast<const ModuleParams*>(&((m_bytes.data())[m_moduleParamsOff])); }
